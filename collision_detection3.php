...
$shapes[] = ['bottom_left'=>[2,0],'top_left'=>[2,2],'bottom_right'=>[4,0],'top_right'=>[4,2]];

?>
<hr><h3>Test 3</h3>
<p>No Collision, Shape 2 below/right of shape 1. Shapes are defined as per below</p>
<img src="img/example-shapes-diag3.png"><br>
